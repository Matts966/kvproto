...
func (x *DataIsNotReady) Reset() {
	*x = DataIsNotReady{}
	mi := &file_errorpb_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataIsNotReady) Descriptor() ([]byte, []int) {
	return file_errorpb_proto_rawDescGZIP(), []int{15}
}
...
func (x *RecoveryInProgress) Reset() {
	*x = RecoveryInProgress{}
	mi := &file_errorpb_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecoveryInProgress) Descriptor() ([]byte, []int) {
	return file_errorpb_proto_rawDescGZIP(), []int{16}
}
...
func (x *FlashbackInProgress) Reset() {
	*x = FlashbackInProgress{}
	mi := &file_errorpb_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FlashbackInProgress) Descriptor() ([]byte, []int) {
	return file_errorpb_proto_rawDescGZIP(), []int{17}
}
...
func (x *FlashbackNotPrepared) Reset() {
	*x = FlashbackNotPrepared{}
	mi := &file_errorpb_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FlashbackNotPrepared) Descriptor() ([]byte, []int) {
	return file_errorpb_proto_rawDescGZIP(), []int{18}
}
...
func (x *MismatchPeerId) Reset() {
	*x = MismatchPeerId{}
	mi := &file_errorpb_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MismatchPeerId) Descriptor() ([]byte, []int) {
	return file_errorpb_proto_rawDescGZIP(), []int{19}
}
...
func (x *UndeterminedResult) Reset() {
	*x = UndeterminedResult{}
	mi := &file_errorpb_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UndeterminedResult) Descriptor() ([]byte, []int) {
	return file_errorpb_proto_rawDescGZIP(), []int{20}
}
...
func (x *Error) Reset() {
	*x = Error{}
	mi := &file_errorpb_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return file_errorpb_proto_rawDescGZIP(), []int{21}
}
...
const file_errorpb_proto_rawDesc = "" +
	"\n" +
	"\rerrorpb.proto\x12\aerrorpb\x1a\fmetapb.proto\x1a\x0frustproto.proto\"N\n" +
	"\tNotLeader\x12\x1b\n" +
	...
	"\rEpochNotMatch\x127\n" +
	"\x0fcurrent_regions\x18\x01 \x03(\v2\x0e.metapb.RegionR\x0ecurrentRegions\"\x96\x01\n" +
	...
	"\x13undetermined_result\x18\x16 \x01(\v2\x1b.errorpb.UndeterminedResultR\x12undeterminedResultR\vstale_epochB\x16ب\b\x01\n" +
...
var file_errorpb_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_errorpb_proto_goTypes = []any{
	...
	(*metapb.Peer)(nil),           // 22: metapb.Peer
	(*metapb.Region)(nil),         // 23: metapb.Region
}
var file_errorpb_proto_depIdxs = []int32{
	22, // 0: errorpb.NotLeader.leader:type_name -> metapb.Peer
	23, // 1: errorpb.EpochNotMatch.current_regions:type_name -> metapb.Region
	0,  // 2: errorpb.Error.not_leader:type_name -> errorpb.NotLeader
	5,  // 3: errorpb.Error.region_not_found:type_name -> errorpb.RegionNotFound
	7,  // 4: errorpb.Error.key_not_in_region:type_name -> errorpb.KeyNotInRegion
	8,  // 5: errorpb.Error.epoch_not_match:type_name -> errorpb.EpochNotMatch
	9,  // 6: errorpb.Error.server_is_busy:type_name -> errorpb.ServerIsBusy
	10, // 7: errorpb.Error.stale_command:type_name -> errorpb.StaleCommand
	4,  // 8: errorpb.Error.store_not_match:type_name -> errorpb.StoreNotMatch
	11, // 9: errorpb.Error.raft_entry_too_large:type_name -> errorpb.RaftEntryTooLarge
	12, // 10: errorpb.Error.max_timestamp_not_synced:type_name -> errorpb.MaxTimestampNotSynced
	13, // 11: errorpb.Error.read_index_not_ready:type_name -> errorpb.ReadIndexNotReady
	14, // 12: errorpb.Error.proposal_in_merging_mode:type_name -> errorpb.ProposalInMergingMode
	15, // 13: errorpb.Error.data_is_not_ready:type_name -> errorpb.DataIsNotReady
	6,  // 14: errorpb.Error.region_not_initialized:type_name -> errorpb.RegionNotInitialized
	3,  // 15: errorpb.Error.disk_full:type_name -> errorpb.DiskFull
	16, // 16: errorpb.Error.RecoveryInProgress:type_name -> errorpb.RecoveryInProgress
	17, // 17: errorpb.Error.FlashbackInProgress:type_name -> errorpb.FlashbackInProgress
	18, // 18: errorpb.Error.FlashbackNotPrepared:type_name -> errorpb.FlashbackNotPrepared
	1,  // 19: errorpb.Error.is_witness:type_name -> errorpb.IsWitness
	19, // 20: errorpb.Error.mismatch_peer_id:type_name -> errorpb.MismatchPeerId
	2,  // 21: errorpb.Error.bucket_version_not_match:type_name -> errorpb.BucketVersionNotMatch
	20, // 22: errorpb.Error.undetermined_result:type_name -> errorpb.UndeterminedResult
